        ...
        <div class="page-content-wrapper">
				<div class="page-content">
					...
					<div class="page-breadcrumb d-none d-md-flex align-items-center mb-3">
						<div class="breadcrumb-title pr-3"><?php echo e($retrieveData[0]->product_name); ?></div>
						<div class="pl-3">
					...
					<div class="card">
						...
						<div class="card-body">
                            <form action="/product/update-product" id="update-product" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control validate-field" value="<?php echo e($retrieveData[0]->product_name); ?>" error-message="Product name is required" id="txtProductName" name="txtProductName" type="text" placeholder="Product Name">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <select class="single-select validate-field" error-message="Product status is required" id="txtProductStatus" name="txtProductStatus">
                                                <?php if($retrieveData[0]->product_status == 1): ?>
                                ...
                                <input type="text" id="txtId" name="txtId" value="<?php echo e($id); ?>" style="display:none;">
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            ...
                                            <?php echo $retrieveData[0]->product_description; ?>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="text" class="form-control  validate-field" value="<?php echo e($retrieveData[0]->product_price); ?>" id="txtProductOriginalPrice" name="txtProductOriginalPrice" error-message="Product original price is required" aria-label="Amount (to the nearest dollar)">
                                    ...
                                    <div class="col-lg-3">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="text" class="form-control" id="txtProductRetailPrice" value="<?php echo e($retrieveData[0]->product_retail_price); ?>" name="txtProductRetailPrice" aria-label="Amount (to the nearest dollar)">
                                                <div class="input-group-append">	<span class="input-group-text">.00</span>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-lg-3">
                                        <div class="form-group">
                                            <label for="product-name">Product Stock:</label>
                                                <input type="text" class="form-control validate-field" value="<?php echo e($retrieveData[0]->stocks); ?>" id="txtProductStock" name="txtProductStock" error-message="Please specify the stock of this product" aria-label="Amount (to the nearest dollar)">
                                                <span class="error-message text-center"></span>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="col-lg-3">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" id="txtGiftPoints" value="<?php echo e($retrieveData[0]->gift_points); ?>" name="txtGiftPoints" type="text" placeholder="Gift Points">
                                            <span class="error-message text-center"></span>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <?php $__currentLoopData = $retrieveData[0]->product_images; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $productImages): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="col-lg-2 text-center" id="product-image-<?php echo e($productImages->id); ?>">
                                            <image src="<?php echo e($productImages->product_image_url); ?> " class="img-thumbnail" style="width:100%; height:200px;">
                                            <button type="button" class="btn btn-danger form-control btn-delete-product-image" id="<?php echo e($productImages->id); ?>" style="margin-top:10px; margin-bottom:10px;">REMOVE THIS IMAGE</button>
                                        </div>
...
</script><?php /**PATH C:\Users\Rhom\Desktop\al files\purefolder\purehappilifeadmin\resources\views/admin/product/single-product-info.blade.php ENDPATH**/ ?>