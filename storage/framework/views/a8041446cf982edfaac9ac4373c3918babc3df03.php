...
<script src="<?php echo e(config('app.cdn') . '/js/product/create-product.js' . '?v=' . config('app.version')); ?>"></script><?php /**PATH C:\Users\Home\Desktop\My Projects\purehappilifeadmin\resources\views/admin/product/create.blade.php ENDPATH**/ ?>