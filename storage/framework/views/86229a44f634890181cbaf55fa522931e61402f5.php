...
<script src="<?php echo e(config('app.cdn') . '/js/product/create-product.js' . '?v=' . config('app.version')); ?>"></script><?php /**PATH C:\Users\Rhom\Desktop\al files\purefolder\purehappilifeadmin\resources\views/admin/product/create.blade.php ENDPATH**/ ?>