										...
										<main>
											<div class="row contacts">
												<div class="col invoice-to">
													...
													<h2 class="to">{{ $dataq->guest_info->first_name }} {{ $dataq->guest_info->last_name }}</h2>
													<div class="address">{{ $dataq->guest_address->address }}</div>
													<div class="email">{{ $dataq->guest_info->email }}
													</div>
												</div>
