                    ...
                    <div class="card radius-10">
						...
						<div class="card-body">
							...
							<div class="row">
									...
									<div class="col-lg-10">
										{{ $data->guest_address->address_complement }}
                                    </div>
                            </div>
							...
							<div class="col-lg-12">
										...
										@endif
										<a href="/order/guest-order-receipt/{{ $id }}" style="margin-top:10px;" class="btn btn-success form-control" target="_blank">View WayBill</a>
										</div>
							</div>
							@endif
